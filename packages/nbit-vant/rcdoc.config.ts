...
export default defineConfig({
  ...
  site: {
    ...
    favicon: '/favicon.png',
    github: 'https://github.com/3lang3/@nbit/vant',
    versions: [
      { title: 'v1', path: 'https://@nbit/vant-v1.3lang.dev' },
      { title: 'v2 alpha', path: 'https://@nbit/vant-v2.surge.sh' },
    ],
    themeConfig: {
      simulator: {
    ...
    // },
    sitemap: {
      hostname: 'https://@nbit/vant.3lang.dev',
    },
  },
  resolve: {
    stackblitz: {
      extra: 'import "@nbit/vant/lib/index.css";',
    },
  },
  build: {
    cjs: {
