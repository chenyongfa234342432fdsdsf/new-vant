...
import { Sku, Button, Toast } from '@nbit/vant';
import type { SkuInstance } from '@nbit/vant';
 ...
 */
import React, { useRef } from 'react';
import { Sku, Button } from '@nbit/vant';
import type { SkuInstance } from '@nbit/vant';
import { getSkuData } from './demo/data';
