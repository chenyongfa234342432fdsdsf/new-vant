    ...
    <footer className='rv-site-footer'>
      <div className='rv-site-footer__wrapper'>
        <div className='rv-site-footer__links'>
          <a
            target='_blank'
            href='https://github.com/3lang3/@nbit/vant/issues'
            rel='noreferrer'
          >
            {isCN ? '意见反馈' : 'Issues'}
          </a>
          <a
            target='_blank'
            href='https://gitee.com/lang3/@nbit/vant'
            rel='noreferrer'
          >
            {isCN ? '码云镜像' : 'Gitee'}
          </a>
          <a
            target='_blank'
            href='https://github.com/3lang3/@nbit/vant/blob/main/CODE_OF_CONDUCT.md'
            rel='noreferrer'
          >
          ...
          <a
            target='_blank'
            href='https://github.com/3lang3/@nbit/vant/projects/4'
            rel='noreferrer'
          >
            Roadmap
          </a>
